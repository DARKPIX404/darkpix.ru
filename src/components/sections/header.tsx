...
import { VibeCodersModal } from "@/components/sections/vibecoders-modal";
...
export function Header({ memberCount }: HeaderProps) {
  ...
  return (
    <>
              ...
              <SheetContent side="right" className="bg-[#0f111a] border-slate-800 w-64 px-6">
                <div className="flex flex-col gap-2 mt-10">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-[#5865F2] hover:bg-[#5865F2]/10 transition-colors py-2 px-2 rounded-md text-left"
                  >
                    <SiDiscord className="w-5 h-5" />
                    VibeCoders
                  </button>
      ...
      <VibeCodersModal isOpen={modalOpen} onClose={closeModal} memberCount={memberCount} />
    </>
  );
}
